...
namespace format
{
  namespace json
  {
      ...
      namespace test
      {
        class number_test___integral_length_Test;
        class number_test___to_string_ll_Test;
        class number_test___to_string_ld_Test;
      }
    #endif
    ...
    #ifdef UNIT_TEST
      friend class test::number_test___integral_length_Test;
      friend class test::number_test___to_string_ll_Test;
      friend class test::number_test___to_string_ld_Test;
    #endif
